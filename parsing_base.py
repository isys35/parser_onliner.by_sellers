...
class Parser:
    ...
    @staticmethod
    def split_list(lst, len_list):
        return [lst[i:i + len_list] for i in range(0, len(lst), len_list)]


class Request:
    def __init__(self, brenchmark_on=False):
        self.headers = {
            'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:74.0) Gecko/20100101 Firefox/74.0'
        }
        self.brenchmark_on = brenchmark_on
